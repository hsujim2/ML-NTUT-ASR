...
# with open('/home/hsujim/ML@NTUT-2021-Autumn-ASR/train-toneless_update.csv',newline='',errors='ignore') as csvfile:
#      rows = csv.reader(csvfile)
#      for row in rows:
#          a=row[0]
#          b=row[1]
#          f=open('/home/hsujim/ML@NTUT-2021-Autumn-ASR/train/txt/' + a + '.txt', 'w')
#          f.write(b)
#          f.close()
#################################################################
